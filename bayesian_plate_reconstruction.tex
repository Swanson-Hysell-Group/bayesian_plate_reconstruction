...
of the continental block but has no way of constraining paleolongitude without additional assumptions, and
...
uncertainty sources into the inversion.
...
Due to the rotational symmetry of Earth's dominantly dipolar magnetic field, paleomagnetic poles do not
...
to effectively damp the effect of outlier poles that could lead to spurious loops in the APW path if there are sufficient data. The width
...
It, too, does not easily incorporate age uncertainties in the poles, nor the uncertainty in pole positions.
...
and we will use this distribution to calculate the likelihood function for pole directions in the model.
...
Additional paleomagnetic poles were developed prior to Idnurm's work, but they show considerably more scatter,
...
which outcrops in the region around Lake Superior, including on the Keweenaw Peninsula.
The province represents the products of a failed rift zone in the middle of Laurentia which was active
from about 1110 to 1080 Ma \citep{swanson2014magmatic, fairchild2016end}.
