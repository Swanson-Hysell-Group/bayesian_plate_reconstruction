...
Figure~\ref{fig:keweenawan_speeds_1}(c) and~\ref{fig:keqeenawan_speeds_1}(d) show the prior and posterior distributions for the ages of the poles,
...
Figure~\ref{fig:keweenawan_speeds_2}(c) and~\ref{fig{keqeenawan_speeds_2}(d) show the prior and posterior distributions for the ages of the poles,
