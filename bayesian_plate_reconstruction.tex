...
\citet{iaffaldano2012reconstructing} employed a similar Bayesian approach to inverting for finite plate rotations.
...
for a pair of poles from the Proterozoic Midcontinent Rift of North America to estimate the range
...
In such an analysis, paleomagnetic poles in a compilation are averaged in steps of 1-10 Myr with a 10-30 Myr
...
The uncertainty of most paleomagnetic poles are calculated assuming a Fisher distribution,
...
Upper and lower age bounds come from estimates from \citet{idnurm1985lateI} and version 4.6 of the Global paleomagnetic database (GPMDB). }
...
In Chapter~\ref{chap:tpw_rate} we performed a scaling analysis for rates of true polar wander and 
...
These TPW rates are well within the maximum rate estimate of 6$^\circ$/Myr from Section~\ref{sec:discussion},
