...
\citet{swanson2015new} generated samples from Fisher distributions
...
In contrast with the classical statistical approach to regularization, the Bayesian
inverse problem can regularize the problem through the choice of prior, by making
