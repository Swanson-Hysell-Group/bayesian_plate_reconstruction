...
\label{sec:apwp}
\begin{figure*}
\includegraphics[width=0.9\textwidth]{figures/cartoon/paleomagnetic_euler_pole.pdf}
...
\begin{table}
\scriptsize
\include{tables/keweenawan_poles}
\caption{}
...
the average Euler pole of \citet{seton2012global}.
