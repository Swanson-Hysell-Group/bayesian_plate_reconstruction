...
\label{sec:apwp}
\begin{figure*}
\includegraphics[width=0.9\textwidth]{figures/gordon.png}
\caption{ Placeholder figure, Gordon 1984. Cartoon showing the basic concept of PEP}
\label{fig:uniform}
\end{figure*}
