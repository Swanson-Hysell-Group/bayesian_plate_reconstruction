...
If we model the probability distribution as being drawn from a Watson distribution, then these angular distances correspond to colatitudes, where the pole is the sampled point. 
...
(though others are possible, such as the Kent or Bingham distributions, c.f. \citet{tauxe2010essentials}).
...
The spread in pole positions can be approximated as a Fisher distribution from which the angle from the mean that contains 95$\%$ of the solutions can be calculated. 
